...
--
-- Host: localhost
-- Generation Time: Oct 27, 2017 at 05:24 PM
...
CREATE TABLE IF NOT EXISTS `useranswers` (
  ...
  `essay1grade` int(11) DEFAULT NULL,
  `essay1max` int(11) DEFAULT NULL,
  PRIMARY KEY (`SrNo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('Administrator', 'admin', 'admin', 'admin', 1, 1, 4);