...
?>
	...
	<!-- Title of page -->
	<font size="+2" face="arial"><center><header><h1>Clone Test</h1></header></center></font>
	<div id="insideBody">
	...
	<tr>
		...
		<?php
			...
			while(isset($result[0])){ //Condition to loop as long as information is being received
				?>
	...
	<tr>
		...
		<?php
			if(isset($_POST['testName'])){ //Checking if a test has been selected
				...
				header("Location: clonedTest.php?acessor=admin&testName=".$testName); //Redirecting to the appropriate page
