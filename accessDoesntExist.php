...
?>
	...
	<head>
		<!-- Name on tab of page -->
		<title>Access Doesn't Exist</title>

		<!-- Redirecting after timer -->
		<meta http-equiv="refresh" content= "2; url='delAccess.php?acessor=admin'"/>
	<head>
	<body>
	<form>
	<!-- Displaying error message -->
		<font size="+2" face="arial"><center><header><h1>Error deleting access type. Type doesn't exist.</h1></header></center></font>
	</form>
