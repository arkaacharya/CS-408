...
?>
	...
	<head>
		<!-- Name on tab of page -->
		<title>Access Already Exists</title>
		
		<!-- Redirecting after timer -->
		<meta http-equiv="refresh" content= "2; url='addAccess.php?acessor=admin'"/>
	<head>
	<body>
	<form>
		<!-- Displaying error message -->
		<font size="+2" face="arial"><center><header><h1>Error adding Access Type. Type already Exists.</h1></header></center></font>
	</form>
	</body>
	</html>
<?php
