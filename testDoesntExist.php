...
?>
	...
	<head>
		<!-- Name on tab of page -->
		<title>Test Doesn't Exists</title>
		
		<!-- Redirecting after time limit -->
		<meta http-equiv="refresh" content= "2; url='delTest.php?acessor=admin'"/>
	<head>
	<body>
	<form>
		<!-- Displaying error message -->
		<center><header><font size="+2" face="arial"><h1>Error deleting Test. Test doesn't Exists.</h1></font></header></center>
	</form>
